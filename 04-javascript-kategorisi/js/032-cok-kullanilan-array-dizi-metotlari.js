...
copyItems.pop() // son ogeyi cikardik
console.log("copyItems", copyItems)
console.log("Items", items)

console.log("kopayalandiktan sonraki hali:")
...
let allUsers = [...femaleUsers, ...maleUsers] // es6 birden fazla array yapisini birlesitmek 
